            ...
            <div>
              <ul style={{ listStyle: " inside " }}>
                <li>
                  ...
                  giving no priority to commercial or political over
                  professional consideration.
                </li>
                <li>
                  Strive to identify all the sources of our information,
                  shielding them with anonymity only when they insist upon it
                  and when they provide vital information — not opinion or
                  speculation; when there is no other way to obtain that
                  information; and when we know the source is knowledgeable and
                  reliable.
                </li>
                <li>
                  ...
                  to us before we publish. What is “reasonable” may depend on
                  the urgency and competitiveness of the story. If we don’t
                  reach the parties involved, we should explain in the story
                  what efforts were made to do so.
                </li>
                <li>
                  Ensure that our analyses represent our best independent
                  judgments rather than our preferences, or those of our
                  sources.
                </li>
                <li>
                  Endeavour to get to the truth and declare it at all times in
                  our programmes and publications in a manner which leaves no
                  doubt about its validity and accuracy.
                </li>
                <li>
                  Present the diverse points of view and opinions without bias
                  and partiality.
                </li>
                <li>
                ...
                <li>
                  Be ready to acknowledge mistakes anytime a question of
                  fairness or accuracy is raised about any aspect of our work,
                  whether by a source, subject or member of the public, decide
