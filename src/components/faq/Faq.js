        ...
        <>
            <div className="faq card mb-1">
                <div className="card-header p-2" id={cardNumber}>
                    <h5 className="mb-0">
                        <button className="question btn text-left" type="button" data-toggle="collapse" data-target={`#${collapseNumber}`} aria-expanded="true" aria-controls={collapseNumber}>
                            Q: {question}
                        </button>
                    </h5>
                </div>
                ...
                <div className="row">
                    <div className="col-12 mx-auto">
                        <div className="accordion" id="paceFaq">
                            <FaqCard cardNumber="question1" collapseNumber="collapse1" question="How many news can I read per day?" 
                                answer="Unlimited."
                            />
                            <FaqCard cardNumber="question2" collapseNumber="collapse2" question="Question 2?" 
                                answer="Amswer 2."
                            />
                        </div>
                    </div>
