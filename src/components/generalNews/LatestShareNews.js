...
const LatestShareNews = ({ next, previous }) => {
  return (
        ...
        <div className="previous">
          {previous.slug ? (
            <div>
              ...
              <Link to={`/latest/${previous.slug}`} className="prev-link">
                {previous.slug}
              </Link>
            </div>
          ) : (
        ...
        <div className="next">
          {next.slug ? (
            <div>
              ...
              <Link to={`/latest/${next.slug}`} className="next-link">
                {next.slug}
              </Link>
            </div>
          ) : (
...
export default LatestShareNews
