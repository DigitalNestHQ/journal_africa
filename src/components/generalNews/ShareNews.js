  ...
  return (
    <div className="row share-icons-container">
        ...
        <div className="share-news">
          <a target="_blank" href={`https://twitter.com/intent/tweet/?text=${post_title}. Read More on&url=tv24africa.com`}>
          ...
          <a target="_blank" href={`https://api.whatsapp.com/send?text=${post_title}. Read More on tv24africa.com`}>
            <span className="share-icon-wrap twt">
              <i className="fab fa-whatsapp wtsapp"></i>{" "}
            </span>
          </a>
          <a target="_blank" href={`https://www.linkedin.com/shareArticle?mini=true&url=https://demo.tv24africa.com&title=${post_title} &summary=${post_title}&source=tv24africa`}>
