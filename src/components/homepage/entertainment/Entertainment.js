...
export const Entertainment = (props) =>{
  ...
  const entertainmentNews = feeds?.filter((news) => news.category_id === "Entertainment");
    ...
    <div className="entertainment custom-container ">
      ...
      <div className="inner-container container-fluid row entertainment-bg-red ml-0">
        <div className="col-12 col-md-6 col-lg-6 entertainment-col-tp my-2 mx-auto">
          <Card>
            <Card.Img className="big-frame-img" src={`https://api.tv24africa.com/public/storage/post_image/${bigFrameNews && bigFrameNews.featured_image}`}/>
            <Card.ImgOverlay>
              <Card.Title><p>{bigFrameNews?.post_title}</p></Card.Title>
            </Card.ImgOverlay>
          </Card>
        </div>
