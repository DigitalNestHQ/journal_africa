...
const ExternalNewsCard = ({
  ...
  return (
    <div className="latest-news-article card sec-2 col-6 col-md-3 col-lg-3 my-4 mx-auto">
      {
        // only show the post type for premium
        post_type == "premium" && (
          <span className="premium-tag premium_category_indicator--latest-news">
            {post_type}
          </span>
        )
      }
