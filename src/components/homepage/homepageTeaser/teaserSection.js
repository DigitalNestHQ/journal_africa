    ...
    <section className="discover">
      <div className="discover-wrapper">
        <div className="content-grid">
          ...
          {width > breakpoint ? <div className="latest-daily">
              ...
              <div className="latest-content">
                {data.slice(13, 17).map((eachCard) => (
                  <div className="latest-card" key={eachCard.id}>
                    <p className="latest-date"><Moment format="MMMM Do YYYY">{eachCard.updated_at}</Moment></p>
                    <h6 className="latest-title">
                      {eachCard.slug}
                    </h6>
