      ...
      <div className="section-content-default privacy-container">
        <div className="section-wrapper-default">
          ...
          <div className="privacy-main-content">
            ...
            <div className="privacy-terms">
              <h5 className="privacy-list-heading slug-default">
                2. Use License
              </h5>
              <div className="privacy-list-content">
                <p className="privacy-license-text">
            ...
            <div className="privacy-terms">
              ...
              <div className="privacy-list-content">
                <p className="privacy-feedback-text">
                  The “Feedback” means the message board or e-mail function
                  offered as part of this Site. If you participate in the
                ...
                <ol className="license-list">
                  ...
                  <li className="license-list-item">
                    Make any bigoted, hateful, or racially offensive statement
                    that infringes human rights.
                  </li>
                  <li className="license-list-item">
                    Advocate illegal activity or discuss illegal activities with
                    the intent to commit them.
                  </li>
                  <li className="license-list-item">
                    Post or distribute any material that infringes and/or
                    violates any right of a third party or any law.
                  </li>
                  <li className="license-list-item">
                  ...
                  <li className="license-list-item">
                    Post or distribute any software or other materials that
                  ...
                  <li className="license-list-item">
                    ...
                    Forum at any time and for any reason.
                  </li>
                </ol>
              </div>
            </div>
            ...
            <div className="privacy-terms">
              ...
              <div className="privacy-list-content">
                <ol className="license-list">
                  ...
                  <li className="license-list-item">
                    Your access to the Site may be terminated immediately
                    without notice from us if in our sole discretion you fail to
                    comply with any term or provision of these terms. Upon
                    termination, you must cease use of the Site and destroy all
                    materials obtained from such site and all copies thereof,
                    whether made under these terms or otherwise.
                  </li>
                </ol>
              </div>
            </div>
            ...
            <div className="privacy-terms">
              ...
              <div className="privacy-list-content">
                <p className="privacy-terms-text">
                  ...
                  understand how we collect, use, communicate, and disclose and
            ...
            <div className="privacy-terms">
              <h5 className="privacy-list-heading slug-default">
                11.1 Personal information you provide to us:
              </h5>
              <div className="privacy-list-content">
                <p className="privacy-terms-text">
            ...
            <div className="privacy-terms">
              <h5 className="privacy-list-heading slug-default">
                11.2 How we use your personal information
              </h5>
              <div className="privacy-list-content">
                <p className="privacy-feedback-text">
                ...
                <ul className="license-list">
                  ...
                  <li className="license-list-item">
                    Provide you target ad serving services (for further
            ...
            <div className="privacy-terms">
              ...
              <div className="privacy-list-content">
                <p className="privacy-terms-text">
                  We will keep your information confidential except when
                  disclosure is required by law or for technical purposes.
                </p>
                <p className="privacy-terms-text">
            ...
            <div className="privacy-terms">
              <h5 className="privacy-list-heading slug-default">
                11.4 Content that you send to us
              </h5>
              <div className="privacy-list-content">
                <p className="privacy-terms-text">
                ...
                <p className="privacy-terms-text">
                  ...
                  Media to use your Content in order to offer their services,
                  and more generally under the conditions specified by the
                  present Terms. <br /> Consequently, you must not share videos
                  that you have not created, or use content in your videos that
                  is protected by copyright, such as music, extracts from
                  protected programs or videos created by third parties if you
                  do not have the required authorizations.
                </p>
                <p className="privacy-terms-text">
                  <b>1.3</b> You undertake not to submit to the Media any
                  Content for which the rights are held by third parties
                  (including the right of ownership, right to privacy, and right
                  of personal portrayal) unless you have obtained from the third
                  party concerned formal authorization to distribute the data
                  concerned and grant to the Media the rights specified in
                  Article 2.2 above.
                </p>
                <div className="privacy-terms-text">
                ...
                <div className="privacy-terms-text">
                  <b>1.4</b> In this connection you may be required to give us
                  your personal data such as your photograph and first
                  name/surname. You expressly authorize us to reproduce them in
                  context with the Content sent.
                </div>
              </div>
            </div>
          </div>
