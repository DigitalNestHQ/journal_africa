...
export const WriteForUs = () => {
  return (
    <>
      <Navbar />
      <section className="write-for-us">
        <div className="write-for-us-heading">
          <h1>WRITE FOR US</h1>
        </div>
        <div className="write-for-us-information">
          <h5>Can I write for TV24 Africa News?</h5>
          <p>
            You can publish content on TV24 Africa News because we are open to
            the plurality and diversity of ideas that are backed with hard facts
            and evidence. Guest contributor who are interested in submitting
            one-off articles may do so by sending their articles. Contributors
            who are interested in writing regularly for TV24 Africa News must
            submit a pitch of what they want to be writing about as well as a
            short bio of themselves.
          </p>
          ...
          <p>
            ...
            from a Pan African perspective. Such articles must also fit into one
            of the sections of TV24 Africa News. Please read through TV24 Africa
            News to get a sense of the sections and the type of articles that we
            publish.
          </p>
          <h5>Where to send guest articles and article pitches?</h5>
          <p>
          ...
          <h5>
            Does TV24 Africa News accept Opinion articles, promotional materials
            etc?
          </h5>
          <p>
            ...
            publication on our sister platform, TV24 Africa News Daily. To send
