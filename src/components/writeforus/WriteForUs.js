        ...
        <div className="section-wrapper-default">
          ...
          <div className="write-for-us-information">
            <h5 className="section-heading-default">
              Can I write for Journal Africa News?
            </h5>
            <p>
              You can publish content on Journal Africa News because we are open
              to the plurality and diversity of ideas that are backed with hard
              ...
              Contributors who are interested in writing regularly for Journal
            ...
            <h5>What types of articles is acceptable on Journal Africa News</h5>
            <p>
              ...
              one of the sections of Journal Africa News. Please read through
              Journal Africa News to get a sense of the sections and the type of
            ...
            <p>
              ...
              info@journalafrica.com. Guest articles should be clearly marked
              guest article, while article pitches should be clearly marked
              article pitch in the subject of the email. Guest articles that
              meets our criteria would be published while those who submit
              pitches for regular writing would be contacted for further
              discussion.
            </p>
            <h5 className="section-heading-default">
              Does Journal Africa News accept Opinion articles, promotional
              materials etc?
            </h5>
            <p>
              Journal Africa news rarely accept opinion articles, eye witness
              reports, promotional pieces or general article ideas, but only for
              publication on our sister platform, Journal Africa News Daily. To
              send opinion articles, eye witness reports etc,
              <br /> please submit them here
              <a href="https://news.tv24africa.com/submityourstory">
                {" "}
                news.journalafrica.com/submityourstory
              </a>
            </p>
            <p>
              For promotional pieces, please send a mail to
              <b> advertising@journalafrica.com </b>
