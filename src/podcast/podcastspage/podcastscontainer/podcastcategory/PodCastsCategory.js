              ...
              return (
                <React.Fragment>
                  <div className="pod_card row pt-4">
                    <div
                      key={title}
                      className="pod_card_image col-12 col-md-5 col-lg-5"
                    >
                      <Card>
                        <Card.Img
                          src={bigImage}
                    ...
                    <div className="col-12 col-md-7 col-lg-7 p-0 right_side_contents">
                      <div className="pod_long_description pt-3">
                        <p>{p1}</p>
                        <p>{p2}</p>
                        <div className="pod_buttons">
                          <button className="play_latest_btn">
                            <i className="fas fa-play"></i> Play Latest episode
                          </button>
                          <button className="sub_topod_btn">
                            Subscribe <span className="">V</span>
                          </button>
                        </div>
                      </div>
                    </div>
                    <div className="hr_lines col-12">
